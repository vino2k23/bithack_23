#include "admin_core_med.h"
#include "ui_admin_core_med.h"
#include "admin_homepage.h"
#include "ui_admin_homepage.h"

#include <QSqlDatabase>

admin_core_med::admin_core_med(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::admin_core_med)
{
    ui->setupUi(this);
    ui->setupUi(this);
...
admin_core_med::~admin_core_med()
{
    delete ui;
}

void admin_core_med::on_admin_core_med_accepted()
{
    ...
    QSqlQuery qry_qn;
    qry_qn.prepare("insert into question_core_med(qn,qn_no,choice_1,choice_2,choice_3,choice_4,crt_choice)values ('"+qn_editor+"','"+qn_number+"','"+choice_1+"','"+choice_2+"','"+choice_3+"','"+choice_4+"','"+crt_choice+"')");
    if(qry_qn.exec())
    {
...
void admin_core_med::on_quit_clicked()
{
    QApplication::quit();
}
